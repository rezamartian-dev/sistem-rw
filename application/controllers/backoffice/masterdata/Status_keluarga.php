...
class Status_keluarga  extends MY_Controller
{
	...
	public function read($pages=1){
		...
		$data[$this->pages]          = 'status_keluarga';
	...
	public function getAll(){
		$read_data = $this->M_crud->read_data($this->tbl,'id,status as nama');
